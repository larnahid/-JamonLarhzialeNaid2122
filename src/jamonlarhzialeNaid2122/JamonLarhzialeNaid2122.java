 ...
 */
public class JamonLarhzialeNaid2122 {
    ...
    public JamonLarhzialeNaid2122 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    // jamon
    
    public JamonLarhzialeNaid2122 (String cat, double precio, int stock)
    {
        this.categoria =cat;
        this.precio=precio;
        this.stock=stock;
   ...
   // Método para asignar la categoría del jamón
    ...
    public void vender (int cantidad, String paisLarhzialeNaid2122) throws Exception
    {
        if (cantidad <= 0)
